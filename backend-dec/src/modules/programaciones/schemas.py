...
class FacturaProgramadaBase(BaseModel):
    ...
    @field_validator('tipo_frecuencia')
    @classmethod
...
class FacturaProgramadaCreacion(BaseModel):
...
class FacturaProgramadaActualizacion(BaseModel):
...
class FacturaProgramadaLectura(FacturaProgramadaBase):
    id: UUID
    empresa_id: UUID

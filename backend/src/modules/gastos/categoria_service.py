...
from .categoria_repository import RepositorioCategoriasGasto
from .categoria_schemas import CategoriaGastoCreacion, CategoriaGastoActualizacion
...
class ServicioCategoriasGasto:
    ...
    def crear_categoria(self, datos: CategoriaGastoCreacion, usuario_actual: dict):
        ...
        try:
            ...
            msg = str(e).lower()
            if any(k in msg for k in ["unique constraint", "uq_categoria_gasto_empresa_codigo", "restricción de unicidad", "llave duplicada"]):
    ...
    def actualizar_categoria(self, id: UUID, datos: CategoriaGastoActualizacion, usuario_actual: dict):
        ...
        try:
            ...
            msg = str(e).lower()
            if any(k in msg for k in ["unique constraint", "uq_categoria_gasto_empresa_codigo", "restricción de unicidad", "llave duplicada"]):
                raise AppError("El código ya está en uso por otra categoría", 409, "CATEGORIA_EXISTS")
            raise e

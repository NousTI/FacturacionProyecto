...
def listar_establecimientos(
    ...
    usuario: dict = Depends(requerir_permiso([PermissionCodes.ESTABLECIMIENTO_GESTIONAR, PermissionCodes.FACTURAS_VER_TODAS, PermissionCodes.FACTURAS_VER_PROPIAS, PermissionCodes.FACTURAS_ENVIAR_SRI])),
    servicio: ServicioEstablecimientos = Depends()
):

...
class PermissionCodes(str, Enum):
    ...
    ESTABLECIMIENTO_CREAR = "ESTABLECIMIENTO_CREAR"
    ESTABLECIMIENTO_EDITAR = "ESTABLECIMIENTO_EDITAR"
    ESTABLECIMIENTO_ELIMINAR = "ESTABLECIMIENTO_ELIMINAR"

    PUNTO_EMISION_VER = "PUNTO_EMISION_VER"
    PUNTO_EMISION_CREAR = "PUNTO_EMISION_CREAR"
    PUNTO_EMISION_EDITAR = "PUNTO_EMISION_EDITAR"
    PUNTO_EMISION_ELIMINAR = "PUNTO_EMISION_ELIMINAR"

...
@Component({
  ...
  styles: [`
    ...
    .value   { font-size: 1.7rem; font-weight: 800; color: black; }
    ...
    .section-header h5 { font-weight: 800; color: black; margin-bottom: 0.2rem; }
    ...
    .iva-monto  { font-size: 1.3rem; font-weight: 800; color: black; }

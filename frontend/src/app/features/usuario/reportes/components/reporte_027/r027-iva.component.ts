...
<div class="fade-in">
  ...
  styles: [`
    ...
    .page-title  { font-weight: 900; color: black; font-size: 1.15rem; margin-bottom: 0.25rem; }
    ...
    .kpi-card {
      ...
      display: flex; flex-direction: column; gap: 0.25rem; min-height: 95px;
    ...
    .kpi-value { font-size: 1.55rem; font-weight: 800; color: black; line-height: 1.1; }
    ...
    .bloque-header h5 { font-weight: 800; color: black; margin-bottom: 0.15rem; font-size: 0.98rem; }
    ...
    .total-val        { font-size: 0.98rem; font-weight: 800; color: black; }
    ...
    .cal-item.active { background: var(--primary-color); border-color: black; }
    .cal-item.active .cal-digito,
    .cal-item.active .cal-dia { color: #fff !important; }
    .cal-digito { font-size: 1.15rem; font-weight: 900; color: black; line-height: 1.2; }
    ...
    .cell-input {
      ...
      background: #f8fafc; color: black; outline: none;

...
@Component({
  ...
  styles: [`
    ...
    .value   { font-size: 1.6rem; font-weight: 800; color: #0f172a; line-height: 1.2; }
    ...
    .section-header h5 { font-weight: 800; color: #1e293b; margin-bottom: 0.2rem; font-size: 1.1rem; }
    ...
    .btn-nav-premium:hover:not(:disabled) { background: #1e293b; color: white; border-color: #1e293b; }
    .page-indicator-premium { min-width: 34px; height: 34px; border-radius: 8px; display: flex; align-items: center; justify-content: center; background: #f1f5f9; color: #1e293b; font-weight: 800; font-size: 0.85rem; padding: 0 0.5rem; }
    ...
    .chart-center-text .percentage { font-size: 1.4rem; font-weight: 800; color: #0f172a; }

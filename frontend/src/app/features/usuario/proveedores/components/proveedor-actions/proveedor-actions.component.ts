...
@Component({
    selector: 'app-proveedor-actions',
    standalone: true,
  ...
  `,
    ...
    .btn-filter-lux:hover { background: #f8fafc; color: #161d35; border-color: #cbd5e1; }
    .btn-create-lux {
      background: #161d35;
      color: white;
      border: none;
    ...
    .shadow-premium-lux { box-shadow: 0 15px 35px rgba(22, 29, 53, 0.15); }
  `]
})
export class ProveedorActionsComponent {

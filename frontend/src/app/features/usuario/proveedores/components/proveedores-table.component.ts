...
@Component({
  ...
  styles: [`
    ...
    .name-editorial { font-weight: 700; color: black; font-size: 0.95rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    .amount-editorial { font-weight: 700; color: black; font-size: 0.9rem; }

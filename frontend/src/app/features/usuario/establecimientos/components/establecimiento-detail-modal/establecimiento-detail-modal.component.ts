...
@Component({
  selector: 'app-establecimiento-detail-modal',
  standalone: true,
      ...
      <div class="modal-container-final" (click)="$event.stopPropagation()">
        ...
        <div class="modal-body-final scroll-custom">
          ...
          <div class="form-section-final">
            ...
            <div class="row g-3">
              <div class="col-md-4">
                <label class="label-final">Código SRI</label>
                <div class="detail-value">{{ establecimiento.codigo }}</div>
              </div>
              <div class="col-md-8">
          ...
          <div class="form-section-final border-0">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <div class="detail-value">{{ establecimiento.created_at | date:'medium' }}</div>
              </div>
              <div class="col-md-6">
                <label class="label-final">Última Actualización</label>
                <div class="detail-value">{{ establecimiento.updated_at | date:'medium' }}</div>
              </div>
            </div>
          </div>
...
export class EstablecimientoDetailModalComponent {

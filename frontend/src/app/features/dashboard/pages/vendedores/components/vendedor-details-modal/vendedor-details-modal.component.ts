      ...
      <div class="modal-content-premium shadow-premium" (click)="$event.stopPropagation()">
        ...
        <div class="modal-header-premium">
          <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="modal-title-premium text-dark fw-bold mb-0">{{ vendedor.nombre }}</h2>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4">
                <div class="perf-card">
                    ...
                    <h4 class="value mb-0">{{ vendedor.empresasAsignadas }}</h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="perf-card">
                    ...
                    <h4 class="value mb-0">
                        {{ (vendedor.empresasAsignadas > 0 ? (vendedor.empresasActivas / vendedor.empresasAsignadas) : 0) | percent }}
                    </h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="perf-card">
                    ...
                    <h4 class="value mb-0">{{ vendedor.ingresosGenerados | currency }}</h4>
                </div>
            </div>
          </div>

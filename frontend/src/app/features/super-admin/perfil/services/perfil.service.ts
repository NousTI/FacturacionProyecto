...
export class PerfilService {
    ...
    private _perfil$ = new BehaviorSubject<SuperadminPerfil | null>(null);

    constructor(private http: HttpClient) { }

    getPerfil(): Observable<SuperadminPerfil | null> {
    ...
    updatePerfil(data: SuperadminPerfilUpdate): Observable<SuperadminPerfil> {

...
@Component({
            ...
            <div class="form-section-final">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <textarea formControlName="description" class="input-final" rows="1" placeholder="Breve detalle de los beneficios..."></textarea>
                </div>
                <div class="col-12">
  ...
  styles: [`
    ...
    .modal-container-final {
      background: var(--bg-main); width: 780px; max-width: 95vw; height: 800px; max-height: 95vh;
    ...
    .modal-body-final { padding: 0 2.5rem 1rem; overflow-y: auto; flex: 1; background: var(--bg-main); }
    ...
    .input-final, .select-final {
      ...
      padding: 0.75rem 1.5rem; font-size: 0.95rem; color: var(--text-main); font-weight: 600; transition: all 0.2s;
    }
    .input-final:focus, .select-final:focus {
      border-color: var(--status-info); outline: none; background: var(--bg-main);
    ...
    .limit-name { font-size: 0.75rem; font-weight: 800; color: var(--text-muted); text-transform: uppercase; }
    .limit-unit { font-size: 0.75rem; color: var(--text-muted); font-weight: 600; }
    .features-wrapper { display: flex; flex-wrap: wrap; gap: 1.25rem; }
    .feature-item { width: calc(50% - 0.75rem); }
    .modal-footer-final { padding: 1.5rem 2.5rem; background: var(--status-neutral-bg); display: flex; justify-content: flex-end; gap: 1rem; border-top: 1px solid var(--border-color); }
    .btn-submit-final {
    ...
    .btn-cancel-final { background: var(--bg-main); color: var(--text-muted); border: 1px solid var(--border-color); padding: 0.75rem 2rem; border-radius: 12px; font-weight: 600; transition: all 0.2s; }
    ...
    .input-final::placeholder { color: var(--text-muted); font-weight: 600; }

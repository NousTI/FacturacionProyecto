...
import { Comision } from '../../services/vendedor-comisiones.service';

@Component({
    selector: 'app-vendedor-comisiones-details-modal',
    standalone: true,
...
export class VendedorComisionesDetailsModalComponent {

...
@Component({
  ...
  styles: [`
    ...
    .activa, .ACTIVA { background: var(--status-success-bg); color: var(--status-success-text); }
    .vencida, .VENCIDA { background: var(--status-danger-bg); color: var(--status-danger-text); }
    .cancelada, .CANCELADA { background: var(--status-neutral-bg); color: var(--status-neutral-text); }
    ...
    .pagado, .PAGADO { background: var(--status-success-bg); color: var(--status-success-text); }
    .pendiente, .PENDIENTE { background: var(--status-warning-bg); color: var(--status-warning-text); }
    .anulado, .ANULADO { background: var(--status-danger-bg); color: var(--status-danger-text); }
